...
const Sidebar = () => {
  ...
  return (
    <>
      <aside
        className={`
        fixed h-[100dvh] overflow-hidden lg:static w-11/12 max-w-[18rem] md:w-72 transition-all rounded-r-2xl bg-white shadow-lg shadow-gray-200/40 dark:shadow-gray-800/60 flex flex-col justify-between px-4 lg:transition-[width] ease-linear
      ...
      >
        <div className="min-h-max py-4 border-b border-b-gray-200 dark:border-b-gray-800">
          <Link
            href="#"
            data-logo-box
            className="flex items-center gap-x-3 text-sm leading-5 font-semibold text-gray-800"
          >
            <span className="w-11 h-11 min-w-[2.75rem] rounded-full bg-[#FDF6EE] p-2 text-white flex items-center justify-center">
          ...
          <ul className="text-gray-700 space-y-2">
            {navItems.map((navItem) => (
              ...
              >
                <Link
                  href={navItem.link}
                  className={`flex items-center gap-x-4 px-3 py-2.5 rounded-md ${
                    navItem.isActive
                      ...
                      : "text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-900"
                            ...
                            `}
                >
                  <span className="min-w-max inline-flex">{navItem.icon}</span>
                  <span
